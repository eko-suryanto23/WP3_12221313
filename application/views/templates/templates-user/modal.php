...
<div class="modal fade" tabindex="-1" id="loginModal" role="dialog">
 ...
 <div class="col-sm-10">
 <input type="text" class="form-control" id="email" name="email" placeholder="Alamat
Email">
 </div>
 </div>
 <div class="form-group row">
...
<div class="modal fade" tabindex="-1" id="modalinfo" role="dialog">
 ...
 <div class="modal-body">
 <i class="alert alert-message alert-success">Waktu Pengambilan Buku 1x24 jam dari
Booking!!!</i>
 </div>
 <div class="modal-footer">
